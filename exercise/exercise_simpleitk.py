...
def register_images(img, label_img, atlas_img):
    ...
    registered_label = sitk.Resample(label_img, atlas_img, transform, interpolator=sitkNearestNeighbor,
...
def postprocess_largest_component(label_img):
    # get the connected components from the label_img
    connected_components = sitk.ConnectedComponent(label_img)

    # order the component by ascending component size
